<?php
    ...
    // require_once("colorFondoNoAplica.php");

    class generalInformeResumen extends FPDF {
        ...
        function Header(){
            ...
            // Logo en Texto
            // $this->SetXY(37,8);
            // $this->Cell(25,15,"QAP-FOR-07",0,0,'C',0);
            // $this->Image('../../css/qap_logo.png',35,7,27);
               $this->Image('../../css/qap_logo.png',249,3,27);
            ...
            // $this->Cell(149.5,20,"Entradas para definir el VAV",1,0,'C',0);
            $this->Cell(149.5,20,"Entradas para definir el Xpt",0,0,'C',0);
            ...
            // $this->Cell(30,5,"Código:",0,0,'L',0);
            
            // $this->SetXY(-65,10);
            // // $this->Cell(30,5,"Vigente desde:",1,0,'L',0);
            // $this->Cell(30,5,"Vigente desde:",0,0,'L',0);
            
            // $this->SetXY(-65,15);
            // // $this->Cell(30,5,"Versión:",1,0,'L',0);
            // $this->Cell(30,5,"Versión:",0,0,'L',0);
            
            // $this->SetXY(-65,20);
            // // $this->Cell(30,5,"Página:",1,0,'L',0);
            // $this->Cell(30,5,"Página:",0,0,'L',0);
            
            
            // Valores de los codigos fijos del formato
            // $this->SetFont('Times','B',7);
            // $this->SetXY(-35,5);
            // // $this->Cell(30,5,"QAP-FOR-07",1,0,'C',0);
            // $this->Cell(30,5,"QAP-FOR-07",0,0,'C',0);

            // $this->SetXY(-35,10);
            // // $this->Cell(30,5,"1-Marzo-2019",1,0,'C',0);
            // $this->Cell(30,5,"1-Marzo-2019",0,0,'C',0);

            // $this->SetXY(-35,15);
            // // $this->Cell(30,5,"2",1,0,'C',0);
            // $this->Cell(30,5,"2",0,0,'C',0);

            $this->SetXY(-45,20);
            // $this->Cell(30,5,"Página " . $this->PageNo() . " de {nb}",1,0,'C',0);
            $this->SetFont('Times','B',9);
            $this->Cell(30,5,"QAP-FOR-07. V2 Vig. 1-Marzo-2019 ",0,0,'C',0);
