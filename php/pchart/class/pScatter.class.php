 ...
 class pScatter
  {
       ...
       if ( $Series["isDrawable"] == TRUE )
        {
         ...
         if ((($n*$Sxx) == ($Sx*$Sx)))
         ...
         else
          {
           ...
           if ( $Y2 > $this->pChartObject->GraphAreaY2 ) { $X2 = $X2 - ($this->pChartObject->GraphAreaY2-$Y2)/$RealM; $Y2 = $this->pChartObject->GraphAreaY2; }
          }
   ...
   function writeScatterLabel($ScatterSerieID,$Points,$Format,$MX)
    {
