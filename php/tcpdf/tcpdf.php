...
// include_once "tablePrinter.php"; // Tempralmente deshabilitado
...
class TCPDF {
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = "Pág. " . $w_page.$this->getAliasNumPage().' de '.$this->getAliasNbPages();
		} else {
			$pagenumtxt = "Pág. " . $w_page.$this->getPageNumGroupAlias().' de '.$this->getPageGroupAlias();
		}
		$this->SetY($cur_y);

		
		// MultiCell
		// Ancho, Alto, Texto, borde, alineacion, relleno, salto de linea, x, y 
		
		// Guia para la informacion del pie de pagina
		$this->SetTextColor(0,0,0);
		// $this->SetFillColor(255,0,0);
		$this->SetLineStyle(array('width' => 0.1, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(100, 0, 0)));
		$this->MultiCell(0, 20, "", 0, 'C', 0, 0, 10, 260);
		

		// Recuadro que imprimie la linea superior
		$this->SetLineStyle(array('width' => 0.1, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)));
		$this->SetTextColor(0,0,0);
		$this->MultiCell(0, 20, "", "T", 'C', 0, 0, 10, 262);


		// Recuadro que imprime el codigo HTML
		$text_footer = "
		   	Información de contacto: Calle 63 C No. 35 - 13 / (601) 222-91-51 - +57 318 271 1649 / Bogotá - Colombia
			<br>Coordinación de programas <a href='mailto:qap@quik.com.co' target='_top'>qap@quik.com.co</a> Contact Center: <a href='mailto:contact.center@quik.com.co' target='_top'>contact.center@quik.com.co</a> Página web: <a href='#'>www.quik.com.co</a>
		";
		$this->SetFontSize(7);
		$this->writeHTMLCell(300, 40, 19, 266, $text_footer);


		// Logo de Quik
	//	$this->Image("css/qlogo.png", 185, 264, 14, 8);
		...
		$this->SetFontSize(6);
		$this->SetXY(207, 2);
		$this->Cell(5, 2, $pagenumtxt, 0, 0, 'C');;
